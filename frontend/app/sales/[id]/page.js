    ...
    return (
      <div className="py-8">
        <div className="text-center py-12">
          <div className="text-[var(--text-secondary)]">Vente non trouvée</div>
          <button
            onClick={() => router.push('/pos')}
            className="mt-4 px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors"
          >
  ...
  return (
    <div className="py-8">
      ...
      <div className="mb-6 flex gap-2 flex-wrap">
        ...
        {sale.isReplacement && (
          <span className="px-3 py-1 rounded text-sm font-medium bg-primary/10 text-primary">
            Remplacement
          </span>
        )}
        {sale.returnSaleId && (
      ...
      <div className="mb-6 p-6 border border-[var(--border-color)] rounded-lg bg-[var(--bg-secondary)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          ...
          <div>
            <div className="text-[var(--text-secondary)] mb-1">Modifiée le</div>
            <div className="text-[var(--text-primary)]">
              {sale.updatedAt
